...
public class ScannerDemo
{
	public static void main(String[] arg)  
	{
		...
		System.out.println("Type your 2nd name, and press Enter");
		String sName = sc.next();	//read next token as String
		System.out.println("Hello " + name + " " + sName);
		
		System.out.println("Type your gender, and press Enter");
		String gender = sc.next();	//read next token as String
